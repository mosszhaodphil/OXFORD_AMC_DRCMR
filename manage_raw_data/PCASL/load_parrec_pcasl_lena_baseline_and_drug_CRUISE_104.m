...
% Lena said, Regarding the pcasl scans. If there are multiple scans,
% just take the first 35 dynamics of the first one and the last 35 dynamics of the second one for the pre-post analysis.
% I think that's the case for 108 as well. They must have stopped the scan half way by pushing the alarm button,
% or some other issue at the time.


% Baseline data
input_file_name = 'Cruise_104_ASL-PSEUDO_1800_SENSE_13_1';

[value, info] = loadParRec(input_file_name);

% 80    80    19     1    92    1     1     1     1     1     2
...
n_asl = 2;
dynamic_begin = 1; % We only use the last 35 measurements here
dynamic_end = 35;
n_repeat = dynamic_end - dynamic_begin + 1; % You should know how many repeats there are
n_shift = 1; % You should know how many shift there are
