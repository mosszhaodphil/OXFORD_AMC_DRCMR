...
%
%  See also: WRITEPARREC, CONVERTPARREC, LOADXMLREC, LOADDICOM, LOADLABRAW
%
%  Dependencies: none
%

%% Revision History
% * 2008.02.29    initial version - brianwelch
% * 2008.03.11    add missing fclose(), add 'reducesingletons' - brianwelch
% * 2008.03.11    store PAR character text pieces in INFO - brianwelch
% * 2008.05.16    update comments - brianwelch
